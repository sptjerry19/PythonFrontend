        ...
        <nav>
          <ul class="flex">
            <li v-for="page in pagination.last_page" :key="page">
              <p
                class="mx-1 flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-tr from-pink-600 to-pink-400 p-0 text-sm text-white shadow-md shadow-pink-500/20 transition duration-150 ease-in-out hover:cursor-pointer"
                @click="paginations(page)"
              >
                {{ page }}
              </p>
            </li>
